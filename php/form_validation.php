...
<body>
    ...
    if (($_SERVER["REQUEST_METHOD"] == "POST")) {
        ...
        if (empty($_POST["name"])) {
            ...
            if ((!preg_match("/^[a-zA-Z-' ]*$/", $Name)) or (str_word_count($name_words) < 2)) {
    ...
    <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
        <div>
            <fieldset>
                ...
                <label class="lcolors">NAME&nbsp;</label>
        ...
        <div>
            <fieldset>
                ...
                <label class="lcolors">EMAIL &nbsp; </label>
        ...
        <div>
            <fieldset class="item">
                ...
                <label class="lcolors">GENDER&nbsp;</label>
        ...
        <div>
            <fieldset>
                ...
                <label class="lcolors">DEGREE&nbsp;</label>
        ...
        <div>
            <fieldset>
                ...
                <label class="lcolors">BLOOD GROUP&nbsp;</label>
